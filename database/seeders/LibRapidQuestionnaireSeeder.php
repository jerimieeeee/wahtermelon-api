...
class LibRapidQuestionnaireSeeder extends Seeder
{
    ...
    public function run(): void
    {
        LibRapidQuestionnaire::upsert([
            ...
            ['id' => 2, 'question' => 'May mga pagkakataon ba na pinag-isipan mo ng maglayas o umalis ng inyong bahay?', 'sequence' => 2],
            ...
            ['id' => 7, 'question' => 'Nakakita ka na ba ng mga ipinagbabawal na "gamut" o drugs?', 'sequence' => 7],
