...
class LibPhilhealthMembershipCategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        LibPhilhealthMembershipCategory::upsert([
            ...
            ['desc' => 'IE - Migrant Worker - Land Based', 'philhealth_cat_id' => 'O'],
            ['desc' => 'IE - Migrant Worker - Sea Based', 'philhealth_cat_id' => 'O'],
            ...
            ['desc' => 'Sponsored - LGU', 'philhealth_cat_id' => 'PG'],
            ['desc' => 'Sponsored - NGA', 'philhealth_cat_id' => 'PS'],
            ['desc' => 'Sponsored - Others', 'philhealth_cat_id' => 'PS'],
