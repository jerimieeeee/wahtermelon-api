...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\FamilyPlanning\PatientFpHistory>
 */
class PatientFpHistoryFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'history_code' => fake()->randomElement(LibFpHistory::pluck('code')->toArray()),
        ];
    }
}
