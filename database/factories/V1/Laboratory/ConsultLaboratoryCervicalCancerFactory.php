...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\Laboratory\ConsultLaboratoryCervicalCancer>
 */
class ConsultLaboratoryCervicalCancerFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $consult = ConsultLaboratory::factory()->create(['lab_code' => 'CCS']);
