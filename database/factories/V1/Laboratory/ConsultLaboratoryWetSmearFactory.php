...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\Laboratory\ConsultLaboratoryWetSmear>
 */
class ConsultLaboratoryWetSmearFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $consult = ConsultLaboratory::factory()->create(['lab_code' => 'WETS']);
