...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\Laboratory\ConsultLaboratoryXray>
 */
class ConsultLaboratoryXrayFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $consult = ConsultLaboratory::factory()->create(['lab_code' => 'XRAY']);
        ...
        return [
            ...
            'xray_type' => fake()->randomElement(LibLaboratoryXrayType::pluck('code')->toArray()),
