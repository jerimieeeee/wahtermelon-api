...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\Laboratory\ConsultLaboratoryMalariaRdt>
 */
class ConsultLaboratoryMalariaRdtFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $consult = ConsultLaboratory::factory()->create(['lab_code' => 'MRDT']);
        ...
        return [
            ...
            'parasite_type' => fake()->randomElement(LibLaboratoryMalariaRdtParasiteType::pluck('code')->toArray()),
            'rdt_number' => fake()->randomDigit(),
