...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\Laboratory\ConsultLaboratoryUltrasound>
 */
class ConsultLaboratoryUltrasoundFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $consult = ConsultLaboratory::factory()->create(['lab_code' => 'USND']);
        ...
        return [
            ...
            'type' => fake()->randomElement(LibLaboratoryUltrasoundType::pluck('code')->toArray()),
