...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\V1\NCD\ConsultNcdRiskScreeningBloodLipid>
 */
class ConsultNcdRiskScreeningBloodLipidFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        return [
            ...
            'total_cholesterol' => fake()->randomNumber(3, true),
            'raised_blood_lipid' => fake()->boolean(),
        ];
    }
}
