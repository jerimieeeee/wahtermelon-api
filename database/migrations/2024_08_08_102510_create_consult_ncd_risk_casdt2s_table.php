...
return new class extends Migration
{
    ...
    {
        Schema::create('consult_ncd_risk_casdt2s', function (Blueprint $table) {
            ...
            $table->char('eye_refer', 50)->nullable();
            $table->char('unaided', 50)->nullable();
            $table->char('pinhole', 50)->nullable();
            $table->char('improved', 50)->nullable();
            $table->char('aided', 50)->nullable();
            $table->char('eye_refer_prof', 50)->nullable();
    ...
    {
        Schema::dropIfExists('consult_ncd_risk_casdt2s');
    }
};
