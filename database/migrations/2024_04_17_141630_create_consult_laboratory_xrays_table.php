...
return new class extends Migration
{
    ...
    {
        Schema::create('consult_laboratory_xrays', function (Blueprint $table) {
            ...
            $table->foreign('xray_type')->references('code')->on('lib_laboratory_xray_types');
        });
    }
    ...
    {
        Schema::dropIfExists('consult_laboratory_xrays');
    }
};
