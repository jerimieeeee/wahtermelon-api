...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('consult_ncd_risk_screening_lipid', function (Blueprint $table) {
            ...
            $table->char('total_cholesterol');
            $table->boolean('raised_blood_lipid');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('consult_ncd_risk_screening_lipid');
    }
};
