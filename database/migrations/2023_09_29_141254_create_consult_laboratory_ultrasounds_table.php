...
return new class extends Migration
{
    ...
    {
        Schema::create('consult_laboratory_ultrasounds', function (Blueprint $table) {
            ...
            $table->foreign('type')->references('code')->on('lib_laboratory_ultrasound_types');
        });
    }
    ...
    {
        Schema::dropIfExists('consult_laboratory_ultrasounds');
    }
};
