...
return new class extends Migration
{
    ...
    {
        Schema::create('consult_laboratory_biopsies', function (Blueprint $table) {
            ...
            $table->foreign('type')->references('code')->on('lib_laboratory_biopsy_types');
        });
    }
    ...
    {
        Schema::dropIfExists('consult_laboratory_biopsies');
    }
};
