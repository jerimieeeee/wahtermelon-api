...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('consult_laboratory_microscopies', function (Blueprint $table) {
            ...
            $table->string('parasite_type')->nullable();
            $table->string('slide_number')->nullable();
            $table->string('parasite_count')->nullable();
    ...
    {
        Schema::dropIfExists('consult_laboratory_microscopies');
    }
};
