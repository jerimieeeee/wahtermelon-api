...
class PatientVitalsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'patient_left_vision_acuity_distance' => $this->patient_left_vision_acuity_distance,
            'patient_left_vision_acuity' => $this->patient_left_vision_acuity,
            'patient_right_vision_acuity_distance' => $this->patient_right_vision_acuity_distance,
