...
class ConsultLaboratoryBiopsyResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'type' => $this->when(! $this->relationLoaded('biopsyTypes'), $this->type),
            'biopsyTypes' => $this->whenLoaded('biopsyTypes'),
            'result' => $this->result,
