...
class ConsultLaboratoryXrayResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'xray_type' => $this->when(! $this->relationLoaded('xrayType'), $this->xray_type),
            'xrayType' => $this->whenLoaded('xrayType'),
            'result' => $this->result,
