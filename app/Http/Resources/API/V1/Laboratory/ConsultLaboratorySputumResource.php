...
class ConsultLaboratorySputumResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'visual_appearance' => $this->visual_appearance,
            'reading' => $this->reading,
            'data_collection_code' => $this->when(! $this->relationLoaded('sputumCollection'), $this->data_collection_code),
            'data_collection' => $this->whenLoaded('sputumCollection'),
