...
class ConsultLaboratoryFecalysisResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'consistency_code' => $this->when(!$this->relationLoaded('consistency'),$this->consistency_code),
            'consistency' => $this->whenLoaded('consistency'),
            'rbc' => $this->rbc,
            'wbc' => $this->wbc,
            'ova' => $this->ova,
            'parasite' => $this->parasite,
            'blood_code' => $this->when(!$this->relationLoaded('blood'),$this->blood_code),
            'blood' => $this->whenLoaded('blood'),
