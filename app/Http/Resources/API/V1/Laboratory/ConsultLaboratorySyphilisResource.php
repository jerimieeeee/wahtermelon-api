...
class ConsultLaboratorySyphilisResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'method_code' => $this->when(! $this->relationLoaded('syphilisTestMethod'), $this->method_code),
            'syphilisTestMethod' => $this->whenLoaded('syphilisTestMethod'),
            'other_method' => $this->other_method,
            'findings_code' => $this->when(! $this->relationLoaded('laboratoryResult'), $this->findings_code),
            'laboratoryResult' => $this->whenLoaded('laboratoryResult'),
