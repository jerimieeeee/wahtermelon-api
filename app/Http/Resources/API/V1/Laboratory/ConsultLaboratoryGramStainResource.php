...
class ConsultLaboratoryGramStainResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'nugent_score' => $this->nugent_score,
            'fungal_elements' => $this->fungal_elements,
            'pus_cells' => $this->pus_cells,
            'gram_negative' => $this->gram_negative,
