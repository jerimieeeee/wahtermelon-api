...
class ConsultLaboratoryGeneXpertResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'collection_date' => $this->laboratory_date->format('Y-m-d'),
            'release_date' => $this->laboratory_date->format('Y-m-d'),
            'mtb' => $this->when(! $this->relationLoaded('mtbResult'), $this->mtb),
            'mtbResult' => $this->whenLoaded('mtbResult'),
            'rif' => $this->when(! $this->relationLoaded('rifResult'), $this->rif),
            'rifResult' => $this->whenLoaded('rifResult'),
