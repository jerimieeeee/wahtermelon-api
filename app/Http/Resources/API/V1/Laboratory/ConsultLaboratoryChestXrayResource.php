...
class ConsultLaboratoryChestXrayResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'remarks_findings' => $this->remarks_findings,
            'observation_code' => $this->when(!$this->relationLoaded('observation'),$this->observation_code),
            'observation' => $this->whenLoaded('observation'),
            'remarks_observation' => $this->remarks_observation,
