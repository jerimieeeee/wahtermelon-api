...
class ConsultLaboratoryMicroscopyResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'parasite_type' => $this->nugent_score,
            'slide_number' => $this->fungal_elements,
            'parasite_count' => $this->pus_cells,
