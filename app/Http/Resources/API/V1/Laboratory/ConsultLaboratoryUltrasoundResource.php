...
class ConsultLaboratoryUltrasoundResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'type' => $this->when(! $this->relationLoaded('ultrasoundTypes'), $this->type),
            'ultrasoundTypes' => $this->whenLoaded('ultrasoundTypes'),
            'result' => $this->result,
