...
class PatientGbvInterviewPhysicalAbuseResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'physical_abused_id' => $this->when(! $this->relationLoaded('physical'), $this->physical_abused_id),
            'physicalAbused' => $this->whenLoaded('physical'),
            'physical_abused_remarks' => $this->physical_abused_remarks,
