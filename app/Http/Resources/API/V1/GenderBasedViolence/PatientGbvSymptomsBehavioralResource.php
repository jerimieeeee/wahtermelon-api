...
class PatientGbvSymptomsBehavioralResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'behavioral_symptoms_id' => $this->when(! $this->relationLoaded('behavior'), $this->behavioral_symptoms_id),
            'symptomsBehavior' => $this->whenLoaded('behavior'),
