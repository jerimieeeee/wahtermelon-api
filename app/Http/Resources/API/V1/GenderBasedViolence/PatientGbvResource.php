...
class PatientGbvResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'outcome_reason_id' => $this->when(! $this->relationLoaded('outcomeReason'), $this->outcome_reason_id),
            'outcome_reason' => $this->whenLoaded('outcomeReason'),
            'outcome_result_id' => $this->when(! $this->relationLoaded('outcomeResult'), $this->outcome_result_id),
            'outcome_result' => $this->whenLoaded('outcomeResult'),
            'outcome_verdict_id' => $this->when(! $this->relationLoaded('outcomeVerdict'), $this->outcome_verdict_id),
