...
class FamilyPlanningReport2018Controller extends Controller
{
    ...
    public function index(Request $request, FamilyPlanningReportService $familyPlanningReportService)
    {
        ...
        $NFPBBT_other_acceptor_previous_month_20_49 = $familyPlanningReportService->other_acceptor($request, 'NFPBBT', '20', '49')->get();
        ...
        //NFPSTM NEW ACCEPTOR PREVIOUS MONTH
        $NFPSTM_new_acceptor_previous_month_10_14 = $familyPlanningReportService->new_acceptor($request, 'NFPSTM', 'NA', '10', '14', 'NA-previous-MONTH')->get();
        $NFPSTM_new_acceptor_previous_month_15_19 = $familyPlanningReportService->new_acceptor($request, 'NFPSTM', 'NA', '15', '19', 'NA-previous-MONTH')->get();
        $NFPSTM_new_acceptor_previous_month_20_49 = $familyPlanningReportService->new_acceptor($request, 'NFPSTM', 'NA', '20', '49', 'NA-previous-MONTH')->get();

        //NFPSTM OTHER ACCEPTOR PRESENT MONTH
        $NFPSTM_other_acceptor_previous_month_10_14 = $familyPlanningReportService->other_acceptor($request, 'NFPSTM', '10', '14')->get();
        $NFPSTM_other_acceptor_previous_month_15_19 = $familyPlanningReportService->other_acceptor($request, 'NFPSTM', '15', '19')->get();
        $NFPSTM_other_acceptor_previous_month_20_49 = $familyPlanningReportService->other_acceptor($request, 'NFPSTM', '20', '49')->get();

        //NFPSTM DROPOUT PRESENT MONTH
        $NFPSTM_dropout_present_month_10_14 = $familyPlanningReportService->dropout($request, 'NFPSTM', '10', '14')->get();
        $NFPSTM_dropout_present_month_15_19 = $familyPlanningReportService->dropout($request, 'NFPSTM', '15', '19')->get();
        $NFPSTM_dropout_present_month_20_49 = $familyPlanningReportService->dropout($request, 'NFPSTM', '20', '49')->get();

        //NFPSTM NEW ACCEPTOR PRESENT MONTH
        $NFPSTM_new_acceptor_present_month_10_14 = $familyPlanningReportService->new_acceptor($request, 'NFPSTM', 'NA', '10', '14', 'NA-present-MONTH')->get();
        $NFPSTM_new_acceptor_present_month_15_19 = $familyPlanningReportService->new_acceptor($request, 'NFPSTM', 'NA', '15', '19', 'NA-present-MONTH')->get();
        $NFPSTM_new_acceptor_present_month_20_49 = $familyPlanningReportService->new_acceptor($request, 'NFPSTM', 'NA', '20', '49', 'NA-present-MONTH')->get();

        //NFPSDM NEW ACCEPTOR PREVIOUS MONTH
        $NFPSDM_new_acceptor_previous_month_10_14 = $familyPlanningReportService->new_acceptor($request, 'NFPSDM', 'NA', '10', '14', 'NA-previous-MONTH')->get();
        $NFPSDM_new_acceptor_previous_month_15_19 = $familyPlanningReportService->new_acceptor($request, 'NFPSDM', 'NA', '15', '19', 'NA-previous-MONTH')->get();
        $NFPSDM_new_acceptor_previous_month_20_49 = $familyPlanningReportService->new_acceptor($request, 'NFPSDM', 'NA', '20', '49', 'NA-previous-MONTH')->get();

        //NFPSDM OTHER ACCEPTOR PRESENT MONTH
        $NFPSDM_other_acceptor_previous_month_10_14 = $familyPlanningReportService->other_acceptor($request, 'NFPSDM', '10', '14')->get();
        $NFPSDM_other_acceptor_previous_month_15_19 = $familyPlanningReportService->other_acceptor($request, 'NFPSDM', '15', '19')->get();
        $NFPSDM_other_acceptor_previous_month_20_49 = $familyPlanningReportService->other_acceptor($request, 'NFPSDM', '20', '49')->get();

        //NFPSDM DROPOUT PRESENT MONTH
        $NFPSDM_dropout_present_month_10_14 = $familyPlanningReportService->dropout($request, 'NFPSDM', '10', '14')->get();
        $NFPSDM_dropout_present_month_15_19 = $familyPlanningReportService->dropout($request, 'NFPSDM', '15', '19')->get();
        $NFPSDM_dropout_present_month_20_49 = $familyPlanningReportService->dropout($request, 'NFPSDM', '20', '49')->get();

        //NFPSDM NEW ACCEPTOR PRESENT MONTH
        $NFPSDM_new_acceptor_present_month_10_14 = $familyPlanningReportService->new_acceptor($request, 'NFPSDM', 'NA', '10', '14', 'NA-present-MONTH')->get();
        $NFPSDM_new_acceptor_present_month_15_19 = $familyPlanningReportService->new_acceptor($request, 'NFPSDM', 'NA', '15', '19', 'NA-present-MONTH')->get();
        $NFPSDM_new_acceptor_present_month_20_49 = $familyPlanningReportService->new_acceptor($request, 'NFPSDM', 'NA', '20', '49', 'NA-present-MONTH')->get();

        //NFPLAM NEW ACCEPTOR PREVIOUS MONTH
        $NFPLAM_new_acceptor_previous_month_10_14 = $familyPlanningReportService->new_acceptor($request, 'NFPLAM', 'NA', '10', '14', 'NA-previous-MONTH')->get();
        $NFPLAM_new_acceptor_previous_month_15_19 = $familyPlanningReportService->new_acceptor($request, 'NFPLAM', 'NA', '15', '19', 'NA-previous-MONTH')->get();
        $NFPLAM_new_acceptor_previous_month_20_49 = $familyPlanningReportService->new_acceptor($request, 'NFPLAM', 'NA', '20', '49', 'NA-previous-MONTH')->get();

        //NFPLAM OTHER ACCEPTOR PRESENT MONTH
        $NFPLAM_other_acceptor_previous_month_10_14 = $familyPlanningReportService->other_acceptor($request, 'NFPLAM', '10', '14')->get();
        $NFPLAM_other_acceptor_previous_month_15_19 = $familyPlanningReportService->other_acceptor($request, 'NFPLAM', '15', '19')->get();
        $NFPLAM_other_acceptor_previous_month_20_49 = $familyPlanningReportService->other_acceptor($request, 'NFPLAM', '20', '49')->get();

        //NFPLAM DROPOUT PRESENT MONTH
        $NFPLAM_dropout_present_month_10_14 = $familyPlanningReportService->dropout($request, 'NFPLAM', '10', '14')->get();
        $NFPLAM_dropout_present_month_15_19 = $familyPlanningReportService->dropout($request, 'NFPLAM', '15', '19')->get();
        $NFPLAM_dropout_present_month_20_49 = $familyPlanningReportService->dropout($request, 'NFPLAM', '20', '49')->get();

        //NFPLAM NEW ACCEPTOR PRESENT MONTH
        $NFPLAM_new_acceptor_present_month_10_14 = $familyPlanningReportService->new_acceptor($request, 'NFPLAM', 'NA', '10', '14', 'NA-present-MONTH')->get();
        $NFPLAM_new_acceptor_present_month_15_19 = $familyPlanningReportService->new_acceptor($request, 'NFPLAM', 'NA', '15', '19', 'NA-present-MONTH')->get();
        $NFPLAM_new_acceptor_present_month_20_49 = $familyPlanningReportService->new_acceptor($request, 'NFPLAM', 'NA', '20', '49', 'NA-present-MONTH')->get();
        ...
        $nfpbbt = [
            ...
            'NFPBBT_other_acceptor_previous_month_20_49' => $NFPBBT_other_acceptor_previous_month_20_49,
        ...
        $nfpstm = [
            //NFPSTM NEW ACCEPTOR PREVIOUS MONTH
            'NFPSTM_new_acceptor_previous_month_10_14' => $NFPSTM_new_acceptor_previous_month_10_14,
            'NFPSTM_new_acceptor_previous_month_15_19' => $NFPSTM_new_acceptor_previous_month_15_19,
            'NFPSTM_new_acceptor_previous_month_20_49' => $NFPSTM_new_acceptor_previous_month_20_49,

            //NFPSTM OTHER ACCEPTOR PRESENT MONTH
            'NFPSTM_other_acceptor_previous_month_10_14' => $NFPSTM_other_acceptor_previous_month_10_14,
            'NFPSTM_other_acceptor_previous_month_15_19' => $NFPSTM_other_acceptor_previous_month_15_19,
            'NFPSTM_other_acceptor_previous_month_20_49' => $NFPSTM_other_acceptor_previous_month_20_49,

            //NFPSTM DROPOUT PRESENT MONTH
            'NFPSTM_dropout_present_month_10_14' => $NFPSTM_dropout_present_month_10_14,
            'NFPSTMT_dropout_present_month_15_19' => $NFPSTM_dropout_present_month_15_19,
            'NFPSTM_dropout_present_month_20_49' => $NFPSTM_dropout_present_month_20_49,

            //NFPSTM NEW ACCEPTOR PRESENT MONTH
            'NFPSTM_new_acceptor_present_month_10_14' => $NFPSTM_new_acceptor_present_month_10_14,
            'NFPSTM_new_acceptor_present_month_15_19' => $NFPSTM_new_acceptor_present_month_15_19,
            'NFPSTM_new_acceptor_present_month_20_49' => $NFPSTM_new_acceptor_present_month_20_49,
        ];

        $nfpsdm = [
            //NFPSDM NEW ACCEPTOR PREVIOUS MONTH
            'NFPSDM_new_acceptor_previous_month_10_14' => $NFPSDM_new_acceptor_previous_month_10_14,
            'NFPSDM_new_acceptor_previous_month_15_19' => $NFPSDM_new_acceptor_previous_month_15_19,
            'NFPSDM_new_acceptor_previous_month_20_49' => $NFPSDM_new_acceptor_previous_month_20_49,

            //NFPSDM OTHER ACCEPTOR PRESENT MONTH
            'NFPSDM_other_acceptor_previous_month_10_14' => $NFPSDM_other_acceptor_previous_month_10_14,
            'NFPSDM_other_acceptor_previous_month_15_19' => $NFPSDM_other_acceptor_previous_month_15_19,
            'NFPSDM_other_acceptor_previous_month_20_49' => $NFPSDM_other_acceptor_previous_month_20_49,

            //NFPSDM DROPOUT PRESENT MONTH
            'NFPSDM_dropout_present_month_10_14' => $NFPSDM_dropout_present_month_10_14,
            'NFPSDM_dropout_present_month_15_19' => $NFPSDM_dropout_present_month_15_19,
            'NFPSDM_dropout_present_month_20_49' => $NFPSDM_dropout_present_month_20_49,

            //NFPSDM NEW ACCEPTOR PRESENT MONTH
            'NFPSDM_new_acceptor_present_month_10_14' => $NFPSDM_new_acceptor_present_month_10_14,
            'NFPSDM_new_acceptor_present_month_15_19' => $NFPSDM_new_acceptor_present_month_15_19,
            'NFPSDM_new_acceptor_present_month_20_49' => $NFPSDM_new_acceptor_present_month_20_49,
        ];

        $nfplam = [
            //NFPLAM NEW ACCEPTOR PREVIOUS MONTH
            'NFPLAM_new_acceptor_previous_month_10_14' => $NFPLAM_new_acceptor_previous_month_10_14,
            'NFPLAM_new_acceptor_previous_month_15_19' => $NFPLAM_new_acceptor_previous_month_15_19,
            'NFPLAM_new_acceptor_previous_month_20_49' => $NFPLAM_new_acceptor_previous_month_20_49,

            //NFPLAM OTHER ACCEPTOR PRESENT MONTH
            'NFPLAM_other_acceptor_previous_month_10_14' => $NFPLAM_other_acceptor_previous_month_10_14,
            'NFPLAM_other_acceptor_previous_month_15_19' => $NFPLAM_other_acceptor_previous_month_15_19,
            'NFPLAM_other_acceptor_previous_month_20_49' => $NFPLAM_other_acceptor_previous_month_20_49,

            //NFPLAM DROPOUT PRESENT MONTH
            'NFPLAM_dropout_present_month_10_14' => $NFPLAM_dropout_present_month_10_14,
            'NFPLAM_dropout_present_month_15_19' => $NFPLAM_dropout_present_month_15_19,
            'NFPLAM_dropout_present_month_20_49' => $NFPLAM_dropout_present_month_20_49,

            //NFPLAM NEW ACCEPTOR PRESENT MONTH
            'NFPLAM_new_acceptor_present_month_10_14' => $NFPLAM_new_acceptor_present_month_10_14,
            'NFPLAM_new_acceptor_present_month_15_19' => $NFPLAM_new_acceptor_present_month_15_19,
            'NFPLAM_new_acceptor_present_month_20_49' => $NFPLAM_new_acceptor_present_month_20_49,
        ];
