...
class AnimalBiteCohortNameListReportController extends Controller
{
    /**
     * Display a listing of the resource.
     */
    public function index(Request $request, ReportAnimalBiteCohortNameListService $nameListService)
    {
