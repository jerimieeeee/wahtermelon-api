...
class ConsultLaboratoryGeneXpertController extends Controller
{
     ...
     */
    public function show(ConsultLaboratoryGeneXpert $consultLaboratoryGeneXpert): ConsultLaboratoryGeneXpertResource
    {
        return new ConsultLaboratoryGeneXpertResource($consultLaboratoryGeneXpert);
    }

    /**
     * Update the specified resource in storage.
     */
    public function update(ConsultLaboratoryGeneXpertRequest $request, ConsultLaboratoryGeneXpert $consultLaboratoryGeneXpert): JsonResponse
    {
        $consultLaboratoryGeneXpert->update($request->validated());
     ...
     */
    public function destroy(ConsultLaboratoryGeneXpert $consultLaboratoryGeneXpert)
    {
        $consultLaboratoryGeneXpert->deleteOrFail();
