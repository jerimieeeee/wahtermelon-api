...
use App\Http\Requests\API\V1\Laboratory\ConsultLaboratoryLipidProfileRequest;
use App\Http\Resources\API\V1\Laboratory\ConsultLaboratoryLipidProfileResource;
...
class ConsultLaboratoryLipidProfileController extends Controller
{
    ...
    public function index(Request $request): ResourceCollection
    {
        ...
        if ($perPage == 'all') {
            return ConsultLaboratoryLipidProfileResource::collection($laboratory->get());
        }

        return ConsultLaboratoryLipidProfileResource::collection($laboratory->paginate($perPage)->withQueryString());
    }
    ...
    {
        return new ConsultLaboratoryLipidProfileResource($lipidProfile);
    }
