...
class MedicinePrescriptionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'konsulta_medicine_code' => 'required_without_all:medicine_code,added_medicine|exists:lib_konsulta_medicines,code',
            'medicine_code' => 'required_without_all:konsulta_medicine_code,added_medicine|exists:lib_medicines,hprodid',
            'added_medicine' => 'required_without_all:konsulta_medicine_code,medicine_code',
