...
class PatientNcdRecordDiagnosisRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'diagnosis_code' => 'required|exists:lib_ncd_record_diagnoses,id',
        ];
    }
    ...
    public function bodyParameters()
    {
        return [
            ...
            'diagnosis_code' => [
                'description' => 'ID of lib ncd record diagnosis',
