...
class ConsultNcdRiskScreeningUrineProteinRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'protein' => 'required|exists:lib_ncd_risk_screening_urine_proteins,id',
            'presence_of_urine_protein' => 'boolean',
        ];
    }
    ...
    public function bodyParameters()
    {
        return [
            ...
            'protein' => [
                ...
                'example' => fake()->randomElement(LibNcdRiskScreeningUrineProtein::pluck('id')->toArray()),
            ],
            'presence_of_urine_protein' => [
                'description' => 'is there a presence urine protein?',
