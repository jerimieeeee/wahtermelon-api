...
class PatientGbvSymptomsCorporalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'corporal_array' => 'nullable|array',
            'corporal_array.*.info_source_id' => 'nullable|exists:lib_gbv_info_sources,id',
            'corporal_array.*.corporal_symptoms_id' => 'nullable|exists:lib_gbv_symptoms_corporals,id',
