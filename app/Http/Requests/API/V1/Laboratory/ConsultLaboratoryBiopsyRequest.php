...
class ConsultLaboratoryBiopsyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'type' => 'required|exists:lib_laboratory_biopsy_types,code',
            'result' => 'nullable',
            'remarks' => 'nullable',
    ...
    public function bodyParameters()
    {
        ...
        return [
            ...
            'type' => [
                'example' => fake()->randomElement(LibLaboratoryBiopsyType::pluck('code')->toArray()),
            ],
            'result' => [
