...
class ConsultLaboratoryGeneXpert extends Model
{
    ...
    public function mtbResult()
    {
        return $this->belongsTo(LibLaboratoryMtbResult::class, 'mtb', 'code');
    }

    public function rifResult()
    {
        return $this->belongsTo(LibLaboratoryRifResult::class, 'rif', 'code');
    }
}
