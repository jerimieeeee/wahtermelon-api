...
class ConsultLaboratoryMalariaRdt extends Model
{
    ...
    public function parasiteType()
    {
        return $this->belongsTo(LibLaboratoryMalariaRdtParasiteType::class, 'parasite_type', 'code');
    }
}
