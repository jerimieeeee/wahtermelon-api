...
class PatientGbvInterviewDevScreening extends Model
{
    ...
    public function devScreening()
    {
        return $this->belongsTo(LibGbvDevelopmentalScreening::class, 'dev_screening_id', 'id');
    }
}
