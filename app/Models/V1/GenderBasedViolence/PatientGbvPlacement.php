...
class PatientGbvPlacement extends Model
{
    ...
    {
        return $this->belongsTo(LibGbvPlacementLocation::class, 'location_id', 'id');
    }

    public function placementType()
    {
        return $this->belongsTo(LibGbvPlacementType::class, 'type_id', 'id');
    }
}
