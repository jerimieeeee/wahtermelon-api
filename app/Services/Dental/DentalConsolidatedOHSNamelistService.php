...
class DentalConsolidatedOHSNamelistService
{
    ...
    public function get_dental_namelist($request)
    {
        return DB::table('consults')
            ...
            ->join('dental_oral_health_conditions', 'consults.id', '=', 'dental_oral_health_conditions.consult_id')
            ->join('dental_medical_socials', 'dental_oral_health_conditions.patient_id', '=', 'dental_medical_socials.patient_id')
